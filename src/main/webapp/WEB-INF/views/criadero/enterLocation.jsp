			                      ...
			                      <form action="#" autocomplete="off" id="add-form">                      
				                    ...
				                    <div class="form-group">
				                      <div class="input-group">
				                        ...
				                        <input type="text" id="info" name="info" readonly value="${criadero.info}" class="form-control" placeholder="<spring:message code="criadinfo" />">
				                      </div>
				                    </div>  
			                        <div class="form-group" style = "display:none">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-address-book"></i></span>
				                        <input type="text" id="tipo" name="tipo" readonly value="${criadero.tipo}" class="form-control" placeholder="<spring:message code="criadtipo" />">
				                      </div>
				                    </div>
				                    ...
				                    <div class="form-group" style = "display:none">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-address-book"></i></span>
				                        <input type="text" id="local" name="local" readonly value="${criadero.local.ident}" class="form-control" placeholder="<spring:message code="local" />">
				                      </div>
				                    </div>
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
				                        <input type="text" id="latitude" name="latitude" readonly value="${criadero.latitude}" class="form-control" placeholder="<spring:message code="latitude" />">
				                      </div>
				                    </div>
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
				                        <input type="text" id="longitude" name="longitude" readonly value="${criadero.longitude}" class="form-control" placeholder="<spring:message code="longitude" />">
				                      </div>
				                    </div>
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
				                        <input type="text" id="zoom" name="zoom" readonly value="${criadero.zoom}" class="form-control" placeholder="<spring:message code="zoom" />">
				                      </div>
				                    </div>
			                        <div class="form-group">
...
<c:set var="waitmessage"><spring:message code="process.wait" /></c:set>
  ...
  jQuery(document).ready(function() {
	...
	if(!(miLat == "" || miLong == "")){
		theMarker = L.marker([${criadero.latitude}, ${criadero.longitude}],{title: "${criadero.info}", draggable: true}).addTo(mymap).on('dragend', function() {
	...
	function onMapClick(e) {
	    ...
	    theMarker = L.marker([lat, lon],{title: "${criadero.info}", draggable: true}).addTo(mymap).on('dragend', function() {
	    	$("#latitude").val(theMarker.getLatLng().lat);
			$("#longitude").val(theMarker.getLatLng().lng);
		});
	}
