              ...
              <table id="lista_localities" class="table table-striped table-bordered datatable" width="100%">
                <thead>
                	<tr>
	                    ...
	                    <th class="hidden-xs"><spring:message code="district" /></th>
                ...
                <tbody>
                	<c:forEach items="${localidades}" var="localidad">
                		<tr>
                			<spring:url value="/admin/localities/{id}/"
                                        var="idUrl">
                                <spring:param name="id" value="${localidad.ident}" />
                            </spring:url>
                            <td><a href="${fn:escapeXml(idUrl)}"><c:out value="${localidad.code}" /></a></td>
                            <td class="hidden-xs"><c:out value="${localidad.name}" /></td>
                            <td class="hidden-xs"><c:out value="${localidad.district.name}" /></td>
                            <td class="hidden-xs"><c:out value="${localidad.district.area.name}" /></td>
                            <c:choose>
                                <c:when test="${localidad.pasive eq '0'.charAt(0)}">
                            ...
                            <td><c:out value="${localidad.recordUser}" /></td>
                            <td><c:out value="${localidad.recordDate}" /></td>
