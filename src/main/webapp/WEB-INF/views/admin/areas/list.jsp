  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="areas" /></li>
      ...
      <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="icon-map"></i> <spring:message code="areas" />
              <div class="card-actions">
              </div>
            </div>
            <div class="card-body">
              <spring:url value="/admin/areas/newEntity/"	var="newEntity"/>	
              ...
              <table id="lista_areas" class="table table-striped table-bordered datatable" width="100%">
                <thead>
                	<tr>
                ...
                <tbody>
                	<c:forEach items="${areas}" var="area">
                		<tr>
                			<spring:url value="/admin/areas/{id}/"
                                        var="idUrl">
                                <spring:param name="id" value="${area.ident}" />
                            </spring:url>
                            <td><a href="${fn:escapeXml(idUrl)}"><c:out value="${area.code}" /></a></td>
                            <td class="hidden-xs"><c:out value="${area.name}" /></td>
                            
                            <c:choose>
                                <c:when test="${area.pasive eq '0'.charAt(0)}">
                            ...
                            <td><c:out value="${area.recordUser}" /></td>
                            <td><c:out value="${area.recordDate}" /></td>
