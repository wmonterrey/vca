  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<spring:url value="/admin/districts/" htmlEscape="true "/>"><spring:message code="districts" /></a></li>
        <li class="breadcrumb-item active"><c:out value="${distrito.code}" /></li>
          	...
          	<div class="row">
	            <div class="col-md-12">
	              <div class="card">
		                  ...
		                  <i class="icon-map"></i>&nbsp;<strong><c:out value="${distrito.name}" /></strong>
		                </div>
	                	<div class="card-body">
	                		<div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="ident" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${distrito.ident}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="code" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${distrito.code}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="area" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${distrito.area.name}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong>
		                        	<c:choose>
										<c:when test="${distrito.pasive=='0'.charAt(0)}">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${distrito.recordUser}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${distrito.recordDate}" /></strong></p>
		                      </div>
		                    </div>
	                    	<spring:url value="/admin/districts/editEntity/{ident}/" var="editUrl">
                              	<spring:param name="ident" value="${distrito.ident}" />
                          	</spring:url>
            					<spring:url value="/admin/districts/disableEntity/{ident}/" var="disableUrl">
                              	<spring:param name="ident" value="${distrito.ident}" />
                          	</spring:url>
                          	<spring:url value="/admin/districts/enableEntity/{ident}/" var="enableUrl">
                              	<spring:param name="ident" value="${distrito.ident}" />
                          	</spring:url>
						</div>
						<div class="card-header">
          				<div class="row float-right mr-4" >
          					...
          					<button id="back_button" onclick="location.href='<spring:url value="/admin/districts/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
					</div>
				</div>
