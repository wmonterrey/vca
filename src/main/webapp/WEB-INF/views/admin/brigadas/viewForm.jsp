  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<spring:url value="/admin/brigades/" htmlEscape="true "/>"><spring:message code="brigades" /></a></li>
        <li class="breadcrumb-item active"><c:out value="${brigada.code}" /></li>
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <i class="fa fa-truck"></i>&nbsp;<strong><c:out value="${brigada.name}" /></strong>
	                </div>
                	<div class="card-body">
                		<div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="ident" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${brigada.ident}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="code" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${brigada.code}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong>
	                        	<c:choose>
									<c:when test="${brigada.pasive=='0'.charAt(0)}">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${brigada.recordUser}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${brigada.recordDate}" /></strong></p>
	                      </div>
	                    </div>
	                    <spring:url value="/admin/brigades/editEntity/{ident}/" var="editUrl">
                        	<spring:param name="ident" value="${brigada.ident}" />
                         </spring:url>
                         <spring:url value="/admin/brigades/disableEntity/{ident}/" var="disableUrl">
                              	<spring:param name="ident" value="${brigada.ident}" />
                         </spring:url>
                         <spring:url value="/admin/brigades/enableEntity/{ident}/" var="enableUrl">
                           	<spring:param name="ident" value="${brigada.ident}" />
                         </spring:url>
					</div>
					<div class="card-header">
          				<div class="row float-right mr-4" >
          					...
          					<button id="back_button" onclick="location.href='<spring:url value="/admin/brigades/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
				  </div>
				</div>
