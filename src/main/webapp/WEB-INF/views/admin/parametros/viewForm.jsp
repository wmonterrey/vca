  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<spring:url value="/admin/parameters/" htmlEscape="true "/>"><spring:message code="parameter" /></a></li>
        <li class="breadcrumb-item active"><c:out value="${parametro.name}" /></li>
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <i class="icon-map"></i>&nbsp;<strong><c:out value="${parametro.name}" /></strong>
	                </div>
                	<div class="card-body">
                		<div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="ident" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${parametro.ident}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="value" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${parametro.value}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${parametro.recordUser}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${parametro.recordDate}" /></strong></p>
	                      </div>
	                    </div>
	                    <spring:url value="/admin/parameters/editEntity/{ident}/" var="editUrl">
                        	<spring:param name="ident" value="${parametro.ident}" />
                         </spring:url>
					...
					<div class="card-header">
          				<div class="row float-right mr-4" >
          					...
          					<button id="back_button" onclick="location.href='<spring:url value="/admin/parameters/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
				  </div>
				</div>
