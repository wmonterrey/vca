  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="foci" /></li>
      ...
      <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="icon-graph"></i> <spring:message code="foci" />
              <div class="card-actions">
              </div>
            </div>
            <div class="card-body">
              <spring:url value="/admin/foci/newEntity/"	var="newEntity"/>	
              <button id="lista_foci_new" onclick="location.href='${fn:escapeXml(newEntity)}'" type="button" class="btn btn-outline-primary"><i class="fa fa-plus"></i>&nbsp; <spring:message code="add" /></button><br><br>	
              <table id="lista_foci" class="table table-striped table-bordered datatable" width="100%">
                <thead>
                	<tr>
                ...
                <tbody>
                	<c:forEach items="${focos}" var="foco">
                		<tr>
                			<spring:url value="/admin/foci/{id}/"
                                        var="idUrl">
