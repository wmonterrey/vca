  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><c:out value="${supervisor.code}" /></li>
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <i class="icon-check"></i>&nbsp;<strong><c:out value="${supervisor.name}" /></strong>
	                </div>
                	<div class="card-body">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${supervisor.code}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${supervisor.recordUser}" /></strong></p>
	                      </div>
	                    </div>
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
	                      <div class="col-md-9">
	                        <p class="form-control-static"><strong><c:out value="${supervisor.recordDate}" /></strong></p>
	                      </div>
	                    </div>
	                    <spring:url value="/admin/supervisors/editEntity/{ident}/" var="editUrl">
                        	<spring:param name="ident" value="${supervisor.ident}" />
                         </spring:url>
                         <spring:url value="/admin/supervisors/disableEntity/{ident}/" var="disableUrl">
                              	<spring:param name="ident" value="${supervisor.ident}" />
                         </spring:url>
                         <spring:url value="/admin/supervisors/enableEntity/{ident}/" var="enableUrl">
                           	<spring:param name="ident" value="${supervisor.ident}" />
                         </spring:url>
					</div>
					<div class="card-header">
          				<div class="row float-right mr-4" >
          					...
          					<button id="back_button" onclick="location.href='<spring:url value="/admin/supervisors/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
				  </div>
				</div>
