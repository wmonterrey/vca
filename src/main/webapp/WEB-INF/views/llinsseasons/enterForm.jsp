...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
	  ...
	  <spring:url value="/llins/season/{ident}/" var="temporadaUrl">
		<spring:param name="ident" value="${ciclo.ident}" />
	  </spring:url>
	  <spring:url value="/llins/season/{ident}/" var="seasonsUrl">
		<spring:param name="ident" value="${ciclo.ident}" />
	  </spring:url>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-note"></i> <spring:message code="edit" /> <spring:message code="strCycle" />
                      ...
                      <form action="#" autocomplete="off" id="add-form">                      
						<div class="form-group">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="ident" name="ident" readonly value="${ciclo.ident}" class="form-control" placeholder="<spring:message code="ident" />">
	                      </div>
	                    </div>	
	                    <div class="form-group">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="code" name="code" value="${ciclo.code}" class="form-control" placeholder="<spring:message code="code" />">
	                      </div>
	                    </div> 
                        ...
                        <div class="form-group">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="name" name="name" value="${ciclo.name}" class="form-control" placeholder="<spring:message code="name" />">
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <fmt:formatDate value="${ciclo.startDate}" var="fecInicio" pattern="dd/MM/yyyy" />
	                    ...
	                    <div class="form-group">
	                      ...
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
	                        <fmt:formatDate value="${ciclo.endDate}" var="fecFin" pattern="dd/MM/yyyy" />
	                    ...
	                    <div class="form-group">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="obs" name="obs" value="${ciclo.obs}" class="form-control" placeholder="<spring:message code="obs" />">
	                      </div>
	                    </div>
                        <div class="form-group">
