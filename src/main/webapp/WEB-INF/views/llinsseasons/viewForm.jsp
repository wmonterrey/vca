  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><c:out value="${ciclo.name}" /></li>
          	...
          	<div class="row">
	            <div class="col-md-12">
	              <div class="card">
		                  ...
		                  <i class="fa fa-calendar"></i>&nbsp;<strong><spring:message code="strCycle" />: <c:out value="${ciclo.name}" /></strong>
		                </div>
	                	<div class="card-body">
	                		<div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="ident" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.ident}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="code" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.code}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="startDate" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.startDate}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="endDate" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.endDate}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="obs" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.obs}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong>
		                        	<c:choose>
										<c:when test="${ciclo.pasive=='0'.charAt(0)}">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.recordUser}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="dateCreated" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${ciclo.recordDate}" /></strong></p>
		                      </div>
		                    </div>
	                    	<spring:url value="/llins/season/editEntity/{ident}/" var="editUrl">
                              	<spring:param name="ident" value="${ciclo.ident}" />
                          	</spring:url>
            					<spring:url value="/llins/season/disableEntity/{ident}/" var="disableUrl">
                              	<spring:param name="ident" value="${ciclo.ident}" />
                          	</spring:url>
                          	<spring:url value="/llins/season/enableEntity/{ident}/" var="enableUrl">
                              	<spring:param name="ident" value="${ciclo.ident}" />
                          	</spring:url>
						</div>
						<div class="card-header">
          				<div class="row float-right mr-4" >
          					...
          					<button id="back_button" onclick="location.href='<spring:url value="/llins/season/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
					</div>
				</div>
