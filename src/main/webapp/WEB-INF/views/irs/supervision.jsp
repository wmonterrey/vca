...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="supervision" /></li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="fa fa-wpexplorer"></i> <spring:message code="supervision" />
                ...
                <div class="card-body">
                  <div class="row">
                  	<div class="col-md-12">
	                  	<form action="#" autocomplete="off" id="supervisiones-form">
		                    ...
		                    <div class="form-group row">
	           			  ...
	           			  <div class="form-group row">
			                  ...
			                  <div class="input-group">
			                    ...
			                    <input id="fecSupervisionRange" name="fecSupervisionRange" class="form-control" disabled type="text">
			                  </div>
		                  </div>
		                  <div class="form-group row">
		                  	  <div class="col-sm-3">
			                  ...
			                  <div class="col-sm-3">
			                    ...
			                    <select id="supervisor" name="supervisor" class="form-control select2-single">
			                    	<option value="ALL"><spring:message code="all"/></option>
			                  ...
			                  <div class="col-sm-3">
			                    ...
			                    <select id="rociador" name="rociador" class="form-control select2-single">
			                    	<option value="ALL"><spring:message code="all"/></option>
		                  ...
		                  <div class="row float-right mr-4" >  
		                    	<button type="submit" class="btn btn-primary" id="buscarsupervision""><i class="fa fa-check"></i>&nbsp;<spring:message code="search" /></button>
				          </div>
	                  	</form>
                  	</div>
                  </div>
		              ...
		              <table id="resultados" class="table table-striped table-bordered datatable" width="100%">
		                <thead>
		                	<tr>
			                    ...
			                    <th class="hidden-xs"><spring:message code="supervisionDate" /></th>
			                    <th class="hidden-xs"><spring:message code="supervisor" /></th>
			                    <th class="hidden-xs"><spring:message code="rociador" /></th>
  ...
  <spring:url value="/irs/supervision/searchSupervisions/" var="searchUrl"/>
  <spring:url value="/irs/supervision/" var="supervisionUrl"/>
  
  <!-- Custom scripts required by this view -->
  <spring:url value="/resources/js/views/BuscarSupervision.js" var="processSearch" />
  <script src="${processSearch}"></script>
  
  <script>
  	jQuery(document).ready(function() {
		var parametros = {supervisionUrl: "${supervisionUrl}",searchUrl: "${searchUrl}",successmessage: "${successmessage}",
