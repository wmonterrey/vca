          	...
          	<div class="row">
	            <div class="col-md-12">
	              <div class="card">
		                  ...
		                  <i class="icon-house"></i>&nbsp;<strong><spring:message code="ownerName" />: <c:out value="${supervision.target.household.ownerName}" /></strong>
		                </div>
	                	<div class="card-body">
	                		<div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="ident" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.ident}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="season" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.target.irsSeason.name}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="code" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.target.household.code}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="locality" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.target.household.local.name}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="supervisionDate" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.supervisionDate}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="rociador" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.rociador.name}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="supervisor" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.supervisor.name}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="obs" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.obs}" /></strong></p>
		                      </div>
		                    </div>
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong>
		                        	<c:choose>
										<c:when test="${supervision.pasive=='0'.charAt(0)}">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.recordUser}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-6 col-form-label"><spring:message code="dateCreated" />:</label>
		                      <div class="col-md-6">
		                        <p class="form-control-static"><strong><c:out value="${supervision.recordDate}" /></strong></p>
		                      </div>
		                    </div>
            				<spring:url value="/irs/supervision/disableEntity/{ident}/" var="disableUrl">
                              	<spring:param name="ident" value="${supervision.ident}" />
                          	</spring:url>
                          	<spring:url value="/irs/supervision/enableEntity/{ident}/" var="enableUrl">
                              	<spring:param name="ident" value="${supervision.ident}" />
                          	</spring:url>
                          	<spring:url value="/irs/supervision/editEntity/{ident}/" var="editUrl">
                              	<spring:param name="ident" value="${supervision.ident}" />
                          	</spring:url>
						</div>
						<div class="card-header">
          				<div class="row float-right mr-4" >
						 	...
						 	<button id="back_button" onclick="location.href='<spring:url value="/irs/supervision/" htmlEscape="true "/>'" type="button" class="btn btn-outline-primary"><i class="fa fa-undo"></i>&nbsp; <spring:message code="back" /></button>
          				</div>
            		</div>
					</div>
				</div>
