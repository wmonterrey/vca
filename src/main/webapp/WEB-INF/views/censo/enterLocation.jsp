  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <div class="container-fluid">
		...
		<spring:url value="/census/saveEntityLocation/" var="saveUrl"></spring:url>
			                    ...
			                    <div class="col-md-12">
			                      <form action="#" autocomplete="off" id="add-form">                      
				                    ...
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
				                        <input type="text" id="code" name="code" readonly value="${vivienda.code}" class="form-control" placeholder="<spring:message code="code" />">
				                      </div>
				                    </div>	
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
				                        <input type="text" id="ownerName" name="code" readonly value="${vivienda.ownerName}" class="form-control" placeholder="<spring:message code="ownerName" />">
				                      </div>
				                    </div>
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
				                        <input type="text" id="latitude" name="latitude" readonly value="${vivienda.latitude}" class="form-control" placeholder="<spring:message code="latitude" />">
				                      </div>
				                    </div>
				                    <div class="form-group">
				                      <div class="input-group">
				                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
				                        <input type="text" id="longitude" name="longitude" readonly value="${vivienda.longitude}" class="form-control" placeholder="<spring:message code="longitude" />">
				                      </div>
				                    </div>
			                        <div class="form-group">
...
<c:set var="waitmessage"><spring:message code="process.wait" /></c:set>
  ...
  jQuery(document).ready(function() {
	...
	if(!(miLat == "" || miLong == "")){
		theMarker = L.marker(["${vivienda.latitude}", "${vivienda.longitude}"],{title: "${vivienda.code}", draggable: true}).addTo(mymap).on('dragend', function() {
	...
	function onMapClick(e) {
	    ...
	    theMarker = L.marker([lat, lon],{title: "${vivienda.code}", draggable: true}).addTo(mymap).on('dragend', function() {
	    	$("#latitude").val(theMarker.getLatLng().lat);
			$("#longitude").val(theMarker.getLatLng().lng);
		});
	}
