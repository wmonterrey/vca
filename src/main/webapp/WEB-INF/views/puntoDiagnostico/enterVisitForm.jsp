  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><c:out value="${pdxv.punto.clave}" /></li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-note"></i> <spring:message code="visit" /> <spring:message code="pdxs" />
                      ...
                      <form action="#" autocomplete="off" id="add-form">                      
						<div class="form-group">
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="ident" name="ident" readonly value="${pdxv.ident}" class="form-control" placeholder="<spring:message code="ident" />">
	                      </div>
	                    </div>	
	                    <div class="form-group"  style = "display:none">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
	                        <input type="text" id="punto" name="punto" readonly value="${puntoDiagnostico.ident}" class="form-control" placeholder="<spring:message code="clave" />">
	                      </div>
	                    </div>  
	                    <div class="form-group">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="icon-pin"></i></span>
	                        <select name="visitType" id="visitType" class="form-control select2-single">
	                        	<option value=""><spring:message code="visitType" /> - <spring:message code="empty" /></option>
	                        	<c:forEach items="${tipoVisita}" var="tipo">
									<c:choose> 
										<c:when test="${tipo.catKey eq pdxv.visitType}">
	                    ...
	                    <fmt:formatDate value="${pdxv.visitDate}" var="fecvisita" pattern="dd/MM/yyyy" />
	                    <div class="form-group">
	                      <label><spring:message code="visitDate" /></label>
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
	                        <input type="text" id="visitDate" name="visitDate" value="${fecvisita}" class="form-control date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="-90d" data-date-end-date="+0d">
	                      </div>
	                    </div> 
	                    <div class="form-group">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-sticky-note-o"></i></span>
	                        <input type="text" id="obs" name="obs" value="${pdxv.obs}" class="form-control" placeholder="<spring:message code="obs" />">
	                      </div>
	                    </div>
                        <div class="form-group">
