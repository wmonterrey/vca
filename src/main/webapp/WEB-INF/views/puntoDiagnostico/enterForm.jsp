            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-note"></i> <spring:message code="edit" /> <spring:message code="pdxs" />
                      ...
                      <form action="#" autocomplete="off" id="add-form">                      
	                    ...
	                    <div class="form-group">
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="clave" name="clave" value="${puntoDiagnostico.clave}" class="form-control" placeholder="<spring:message code="clave" />">
	                      </div>
	                    </div>  
	                    <div class="form-group">
	                      <div class="input-group">
	                        ...
	                        <select name="tipo" id="tipo" class="form-control select2-single">
	                        	<option value=""><spring:message code="tipo" /> - <spring:message code="empty" /></option>
	                        	<c:forEach items="${tipoPuntoDx}" var="tipo">
									<c:choose> 
										<c:when test="${tipo.catKey eq puntoDiagnostico.tipo}">
	                    ...
	                    <div class="form-group">
	                      <div class="input-group">
	                        ...
	                        <select name="status" id="status" class="form-control select2-single">
	                        	<option value=""><spring:message code="estpdx" /> - <spring:message code="empty" /></option>
	                        	<c:forEach items="${estadoPuntoDx}" var="estado">
									<c:choose> 
										<c:when test="${estado.catKey eq puntoDiagnostico.status}">
											<option selected value="${estado.catKey}"><spring:message code="${estado.messageKey}" /></option>
										</c:when>
										<c:otherwise>
	                      ...
	                      <div class="input-group">
	                        ...
	                        <select name="local" id="local" class="form-control select2-single">
	                        	...
	                        	<c:forEach items="${localidades}" var="localidad">
									<c:choose> 
										<c:when test="${localidad.ident eq puntoDiagnostico.local.ident}">
	                    ...
	                    <div class="form-group">
	                      <div class="input-group">
	                        ...
	                        <input type="text" id="latitude" name="latitude" value="${puntoDiagnostico.latitude}" class="form-control" placeholder="<spring:message code="latitude" />">
	                      </div>
	                    </div>
	                    <div class="form-group">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
	                        <input type="text" id="longitude" name="longitude" value="${puntoDiagnostico.longitude}" class="form-control" placeholder="<spring:message code="longitude" />">
	                      </div>
	                    </div>
	                    <div class="form-group">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
	                        <input type="text" id="zoom" name="zoom" value="${puntoDiagnostico.zoom}" class="form-control" placeholder="<spring:message code="zoom" />">
	                      </div>
	                    </div>
	                    <div class="form-group">
	                      <div class="input-group">
	                        <span class="input-group-addon"><i class="fa fa-sticky-note-o"></i></span>
	                        <input type="text" id="info" name="info" value="${puntoDiagnostico.info}" class="form-control" placeholder="<spring:message code="infopdx" />">
	                      </div>
	                    </div>
                        <div class="form-group">
