...
public class DatosMapaController {

    private static final Logger logger = LoggerFactory.getLogger(DatosMapaController.class);
     ...
     * @return Datos JSON
     */
    @RequestMapping(value = "datosmapas", method = RequestMethod.GET, produces = "application/json")
    public @ResponseBody
    DatosMtild getDatos(){
     ...
     */
    @RequestMapping(value = "datosmapas", method = RequestMethod.POST, consumes = "application/json")
