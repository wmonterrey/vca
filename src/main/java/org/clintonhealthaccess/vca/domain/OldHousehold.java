 ...
 */
@Entity
@Table(name = "oldhouseholds", catalog = "vca")
public class OldHousehold extends BaseMetaData implements Auditable{
	/**
	 * 
	 */
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OldHousehold))
			return false;
		
		OldHousehold castOther = (OldHousehold) other;
